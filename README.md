...
A Tidbyt app that displays a new USCIS civics test question and answer every 6 hours. Study for the U.S. citizenship test one question at a time!
...
- **Automatic updates** — new question every 6 hours via GitHub Actions
...
Each time the app renders (every 6 hours via GitHub Actions), it displays:
